...
public class VideoData {
	...
	private VideoComboData[] crop;
	private VideoComboData[] fert;
	private VideoComboData[] agro;
	private VideoComboData[] addTown;
	...
	public VideoComboData[] getCrop() {
		return crop;
	}

	public void setCrop(VideoComboData[] crop) {
		this.crop = crop;
	}

	public VideoComboData[] getFert() {
		return fert;
	}

	public void setFert(VideoComboData[] fert) {
		this.fert = fert;
	}

	public VideoComboData[] getAgro() {
		return agro;
	}

	public void setAgro(VideoComboData[] agro) {
		this.agro = agro;
	}

	public VideoComboData[] getAddTown() {
		return addTown;
	}

	public void setAddTown(VideoComboData[] addTown) {
